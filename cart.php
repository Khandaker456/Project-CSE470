...
<head>
	...
	<title>Gimmick - wishlist page</title>
</head>
<body>
	...
	<div class="main">		
		...
		<section class="products">
			<h1 class="title">product added in the cart</h1>
			...
			<div class="cart-total">
				...
				<div class="button">
					<form method="post">
						<button type="submit" name="empty_cart" class="btn" onclick="return confirm('are you sure')">empty cart</button>
					</form>
